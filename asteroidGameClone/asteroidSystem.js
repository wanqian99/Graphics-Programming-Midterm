class AsteroidSystem {
    ...
    spawn(){
        if (random(1)<0.01){
            ...
            //generate random value, and push each colour value 'r,g,b,a' into respective array
            this.r.push(random(0,255));
            this.g.push(random(0,255));
            this.b.push(random(0,255));
            this.alpha.push(random(100,255));
        }
    }
    ...
    draw(){
        ...
        for (var i=0; i<this.locations.length; i++){
            //random colour for each asteroid
            fill(this.r[i], this.g[i], this.b[i], this.alpha[i]);
